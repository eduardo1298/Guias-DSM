...
class AddActivity : AppCompatActivity() {
        ...
        binding.saveButton.setOnClickListener {
            ...
            with(binding) {
                if (name.isNullOrBlank() ) {
                    Snackbar.make(this.root, "El campo nombre está vacío", Snackbar.LENGTH_SHORT)
                        .show()
                }else if(description.isNullOrBlank()){
                    Snackbar.make(this.root, "El campo descripción está vacío", Snackbar.LENGTH_SHORT)
                        .show()
                }else if(location.isNullOrEmpty()){
                    Snackbar.make(this.root, "El campo lugar está vacío", Snackbar.LENGTH_SHORT)
                        .show()

                }else if(filePath === null){
                    Snackbar.make(this.root, "Debe subir una foto del lugar", Snackbar.LENGTH_SHORT)
                        .show()
                } else {
                    uploadImage(type)
                }
    ...
    private fun addplace(type:String,path:String) {
       ...
       // val favorite = false
        ...
        Toast.makeText(
            baseContext, "Su solicitud para añadir el lugar se creó con éxito",
            Toast.LENGTH_SHORT
        ).show()
        finish()
    }
